...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($resultPass) && isset($resultPass['row1']['passCode'])) {
        ...
        header('Location: \PHPGames-main\public\form\signin-form.php'); // Adjust to your game's main page
        exit;
    }
    ...
    if (password_verify($password, $hashedPassword)) {
        ...
        header('Location: \PHPGames-main\public\form\game-form.php'); // Adjust to your game's main page
        exit;
    } else {
